...
from agents import (
    ...
    Runner,
    TResponseInputItem,
    trace, set_trace_processors, enable_verbose_stdout_logging,
)
...
triage_agent = RealtimeAgent(
    ...
    instructions=(
        ...
        " allways sayes i am kuldeep how are you ask would like to do meeting or want to create any app Greet briefly in Indian English + Hindi. Route based on intent:\n"
...
# =========================
# Voice Workflow for VoicePipeline
# =========================
...
class MyWorkflow(VoiceWorkflowBase):
    def __init__(self, secret_word: str, on_start: Callable[[str], None]):
        ...
        self._current_agent = triage_agent  # Use the triage agent as starting point
